...
// PrecedenceGroup defines operator binding associativity and relative precedence.
...
func (pg *PrecedenceGraph) initBuiltins() {
	...
	// Standard library operator to precedence group mappings.
...
// HigherThan reports whether group g1 is strictly higher precedence than g2.
