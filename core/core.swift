...
//
// Its body is in the standard library rather than in an instruction,
// so unlike everything above it this is a call: `print("hi")` reaches
// `$ss5print_9separator10terminatoryypd_S2StF`, which is the symbol
// this declaration mangles to. The variadic list becomes an array of
