...
func resultOwnership(op Op, aux Aux, t Type, args []*Value) Ownership {
	...
	// addresses above; applied to an alloc_box -- which is what
	// SILGen marks for an initializer's self -- it is the box, and
	// answering None there left the box owned by a value nothing
	// consumed.
