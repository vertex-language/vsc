...
// silAttrs are keyword attributes that should not be normalized as symbols.
...
// Normalize strips comments and renumbers symbols and %n SSA values to canonical form
// for differential testing comparisons between vsc and swiftc output.
