...
public func tally(_ xs: [String]) -> [String: Int] { return [:] }
public func uniq(_ xs: Set<String>, _ d: [Int: [String: Int]]) -> Set<Int> { return [] }
public func keys(_ a: [String: String], _ b: Set<[Int]>) {}
