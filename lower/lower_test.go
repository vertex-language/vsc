...
//
// The example is a struct with a Dictionary in it. A Dictionary is a
// type this package has no register for, and a struct holding one has
// no layout -- so the parameter cannot be passed, and saying so is
