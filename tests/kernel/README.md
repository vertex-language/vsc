...
`001`–`073` in the order the rungs climb, from an empty kernel to programs
...
| --- | --- | --- | --- |
| `tests/kernel/` | `001`–`073` `.vs` | the file's `// want:` lines | stdout, on the CPU device and on Metal |
