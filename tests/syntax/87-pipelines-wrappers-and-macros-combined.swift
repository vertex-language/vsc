// Pipeline operators, property wrappers and macro attributes, in one
// file. A second pass over the same idea as 77: each construct is
// covered on its own elsewhere, and what is covered here is their
// combination.
