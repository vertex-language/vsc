// Custom operators, generic constraints and control flow, in one
// file: the constructs meet each other here rather than standing
// alone, which is where a parser that handles each separately can
// still come apart.
